...
In the spirit of sharing, we incourage people to take our project and create their own shainrg communities.  
...
For your set up use the provided sample_database_pg.yml as a template for setting up your database
settings.  Rename the file to database.yml
...
The main color you will want to alter are:
html { 
