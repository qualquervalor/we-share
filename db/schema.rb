...
ActiveRecord::Schema.define(version: 20140119053027) do
  ...
  add_index "borrows", ["resource_id"], name: "index_borrows_on_resource_id", using: :btree
  ...
  add_index "resources", ["borrow_id"], name: "index_resources_on_borrow_id", using: :btree
